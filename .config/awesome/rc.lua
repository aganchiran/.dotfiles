...
globalkeys = gears.table.join(
    awful.key({                   }, "Print", function () awful.spawn("flameshot gui") end, {description = "show help", group="awesome"}),
...
-- Floating clients handler
require("clients.floating_handler")

-- Titlebars
require("titlebars.spacedrol")
